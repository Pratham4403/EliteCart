...
const AllOrders = () => {
  ...
  const fetchOrderDetails = async () => {
    const response = await fetch(SummaryApi.all_orders.url, {
  ...
  return (
    <div className="min-h-screen py-10 px-4 md:px-10">
      ...
      {
        !data[0] && (
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center mx-auto mt-20 border border-gray-100">
