...
const UploadProduct = ({onClose,fetchData})=>{
    const [data,setData] = useState({
        ...
        description : "",
        price : "",
        sellingPrice : "",                                                   //Selling refer to discounted price
    });
            ...
            <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
                ...
                <form className="grid p-4 gap-2 overflow-y-scroll h-full pb-5" onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="category" className="mt-3 font-semibold">Category : </label>
                                            ...
                                            data.productImage.map((element,index)=>{
                                                return(
                                                    <div className="relative group">
                                                        ...
                                                        <div className="absolute w-7 h-7 mb-1 mr-1 bottom-0 right-0 p-1 text-white bg-gray-400 rounded-full hidden group-hover:block cursor-pointer" onClick={()=>{handleDeleteProductImage(index)}}> 
                        ...
                        <label htmlFor="description" className="mt-3 font-semibold">Description : </label>
                        <textarea 
                        ...
                        <button className="mb-14 mt-7 ml-48"><UploadProductButton/></button>
                </form>
            </div>
